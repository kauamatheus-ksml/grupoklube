...
<body>
        ...
        <div class="container">
            <nav class="nav">
                ...
                <ul class="nav-menu" id="nav-menu">
                    ...
                    <li class="nav-item"><a href="views/auth/login.php" class="nav-link">Entrar</a></li>
                    <li class="nav-item"><a href="views/auth/register.php" class="nav-link btn">Cadastre-se</a></li>
                </ul>
            </nav>
        </div>
    </header>
        ...
        <div class="container">
            <div class="hero-content">
                ...
                <div class="hero-buttons">
                    <a href="views/auth/register.php" class="btn btn-white">Começar Agora</a>
    ...
    <section class="cta">
        <div class="container">
            ...
            <a href="views/auth/register.php" class="btn btn-white">Criar Conta Grátis</a>
        </div>
    </section>
    ...
    <section class="section" id="parceiros">
        <div class="container">
            ...
            <div style="text-align: center; margin-top: 2rem;">
                <a href="views/stores/register.php" class="btn btn-primary">Seja um Parceiro</a>
            </div>
        </div>
    </section>
            ...
            <div class="footer-grid">
                ...
                <div class="footer-column">
                    ...
                    <ul class="footer-links">
                        ...
                        <li class="footer-link"><a href="views/stores/register.php">Seja um Parceiro</a></li>
                    </ul>
                </div>

        ...
        case 'recover':
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                ...
                if ($result['status']) {
                    ...
                    header('Location: ../views/auth/recover-password.php?success=' . urlencode($result['message']));
                    exit;
                } else {
        ...
        case 'reset':
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                ...
                if ($result['status']) {
                    ...
                    // Redirecionar com mensagem de erro
                    header('Location: ../views/auth/recover-password.php?error=' . urlencode($result['message']) . '&token=' . urlencode($token));
                    exit;
                }
            }
            break;

...
<body>
    ...
    <div class="container" style="margin-top: 80px;">
        ...
        <div class="dashboard-header">
            ...
            <div>
                <a href="statement.php" class="btn btn-primary">Ver Extrato Completo</a>
            </div>
        </div>
        ...
        <div class="dashboard-grid">
            ...
            <div>
                ...
                <div class="card">
                    ...
                    <a href="statement.php" class="see-all">Ver todas as transações</a>
                </div>
            ...
            <div>
                ...
                <div class="card">
                    ...
                    <a href="partner-stores.php" class="see-all">Ver todas as lojas parceiras</a>
                </div>

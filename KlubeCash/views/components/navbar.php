...
<nav class="navbar">
    ...
    <!-- Logo e Título -->
    <a href="<?php echo $isLoggedIn ? ($isAdmin ? '../../views/admin/dashboard.php' : '../../views/client/dashboard.php') : '../../index.php'; ?>" class="navbar-brand">
    ...
    <div class="navbar-menu">
        <ul class="navbar-links" id="navbarLinks">
            <?php if (!$isLoggedIn): ?>
                ...
                <li class="navbar-item">
                    <a href="../../views/stores/register.php" class="navbar-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <li class="navbar-item">
                    <a href="../../views/auth/login.php" class="navbar-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <li class="navbar-item">
                    <a href="../../views/auth/register.php" class="navbar-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <?php elseif ($isClient): ?>
                <!-- Menu para clientes -->
                <li class="navbar-item">
                    <a href="../../views/client/dashboard.php" class="navbar-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
                            <polyline points="9 22 9 12 15 12 15 22"></polyline>
                        </svg>
                ...
                <li class="navbar-item">
                    <a href="../../views/client/statement.php" class="navbar-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <li class="navbar-item">
                    <a href="../../views/client/partner-stores.php" class="navbar-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M3 3h18v18H3zM21 9H3M21 15H3M12 3v18"></path>
                        </svg>
                        Lojas Parceiras
            ...
            <?php elseif ($isAdmin): ?>
                ...
                <li class="navbar-item">
                    <a href="../../views/admin/dashboard.php" class="navbar-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
                            <polyline points="9 22 9 12 15 12 15 22"></polyline>
                        </svg>
        ...
        <?php if ($isLoggedIn): ?>
            ...
            <div class="navbar-user">
                ...
                <div class="user-dropdown" id="userDropdown">
                    <?php if ($isClient): ?>
                        <a href="../../views/client/profile.php" class="dropdown-item">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <?php elseif ($isAdmin): ?>
                        <a href="../../views/admin/settings.php" class="dropdown-item">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
